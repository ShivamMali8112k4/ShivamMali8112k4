...
Focus: Embedded Systems | IoT | Robotics | Automation 

### Skills

- Embedded: Arduino, ESP8266, Raspberry Pi, ESP's 
- Programming: C, C++, HTML, CSS  
- Design & Simulation: Fusion 360, Blender, MATLAB, ThinkerCAD, Multisim  
- IoT Platforms: ThingSpeak, Blynk, Arduino Cloud

### Projects
- IoT Surveillance Drone – communication and control system  
- Robotics Projects – robot arm and automation systems  
- ESP8266 IoT Systems – cloud-connected sensor monitoring  
...
![Tinkercad](https://img.shields.io/badge/Tinkercad-1477FF?logo=autodesk&logoColor=white)
...
![Multisim](https://img.shields.io/badge/Multisim-1A6AFF?logo=national-instruments&logoColor=white)
...
![Arduino Cloud](https://img.shields.io/badge/Arduino%20Cloud-0086FF?logo=arduino&logoColor=white)
